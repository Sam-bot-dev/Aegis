...
async function loadDemoFrame(): Promise<Uint8Array> {
  // Tiny embedded JPEG — a 1×1 pixel magic header is enough for the pipeline to
  // accept a frame; the Gemini path will return OTHER/low-conf on it which is
  // fine for showing the wiring. Replace with a real kitchen-fire still before
  // the final demo if available at /public/demo-frame.jpg.
  try {
